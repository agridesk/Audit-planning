 ...
 * BUILD: 2026-09-23_AMS03_PHASE8_10_LIVE_READ_R1
...
function RUN_AMS03_PHASE8_10_LIVE_READ_ACCEPTANCE(){
 ...
 var d=null,trip=null,comm=null,handover=null;
 ...
 if(row){
  ...
  try{comm=getPlanningCompanyCommunicationV5({companyUids:[row.companyUid]});q('companyCommunicationRead',comm&&comm.success===true,'companies='+(comm&&comm.companies?comm.companies.length:0));}catch(e3){q('companyCommunicationRead',false,String(e3));}
  try{handover=getPlanningHandoverV5({companyUid:row.companyUid,auditId:row.auditId});q('handoverRead',handover&&handover.success===true,'');}catch(e4){q('handoverRead',false,String(e4));}
