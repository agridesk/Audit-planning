 ...
 * BUILD: 2026-09-23_AMS03_PHASE9_COMM_PROFILES_R1
 ***********************************************************************/
function RUN_AMS03_PHASE9_COMMUNICATION_PROFILES_ACCEPTANCE(){
 var h=String(getPlanningHandoverV5),d=String(PlanningCompanyProposalDraft_build),r=[];function q(n,v){r.push({name:n,ok:!!v});}
