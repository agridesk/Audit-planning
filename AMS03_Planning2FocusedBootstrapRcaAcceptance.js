 ...
 * BUILD: 2026-09-24_AMS03_PLANNING2_FOCUSED_BOOTSTRAP_RCA_R4
 * Read-only acceptance for the focused Plan(auditId) hot path.
 ***********************************************************************/
var AMS03_P2_FOCUSED_RCA_BUILD='2026-09-24_AMS03_PLANNING2_FOCUSED_BOOTSTRAP_RCA_R4';
...
function RUN_AMS03_PLANNING2_FOCUSED_BOOTSTRAP_RCA_ACCEPTANCE(){
 ...
 results.push(A3F_test_('focusedEligibilityUsesCanonicalFacade',A3F_has_(A3F_src_(CPS_focusedEligibility_),'_mp_getQualifiedAuditorsFastList_'),'Single-audit bootstrap uses canonical fast hard-qualification owner; rotation is deferred.'));
