 ...
 * BUILD: 2026-09-24_AMS03_PLANNING2_MIGRATION_HARDENING_R3
 * Read-only acceptance for role mutation hardening + focused P0 path.
 ***********************************************************************/
var AMS03_P2_MIGRATION_HARDENING_BUILD='2026-09-24_AMS03_PLANNING2_MIGRATION_HARDENING_R5';
...
function RUN_AMS03_PLANNING2_MIGRATION_HARDENING_ACCEPTANCE(){
 ...
 decision=A3MH_src_(PlanningWorkspaceDecisionReadModel_get),conceptInput=A3MH_src_(CPS_demandInput_),boot=A3MH_src_(PlanningWorkspaceRpc_bootstrap);
 ...
 r.push(A3MH_test_('focusedAuditIdPropagated',A3MH_has_(conceptInput,"'auditId'")&&A3MH_has_(decision,'PlanningWorkspacePlannedAuditReadService_get'),'Focused auditId survives Concept Planning and target planning window drives focused bootstrap period.'));
