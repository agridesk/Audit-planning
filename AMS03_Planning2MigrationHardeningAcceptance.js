...
function RUN_AMS03_PLANNING2_MIGRATION_HARDENING_ACCEPTANCE(){
 ...
 r.push(A3MH_test_('workspaceUiPreservesDeferredHours',A3MH_has_(client,'function hoursKnown')&&A3MH_has_(client,"hoursToPlanState!=='DEFERRED'"),'Workspace UI does not display deferred hours as a factual zero.'));
