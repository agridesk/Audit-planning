...
// BUILD: 2026-09-24_AMS03_PLANNING2_WORKSPACE_READ_PATH_R1
function RUN_AMS03_PLANNING2_WORKSPACE_READ_PATH_ACCEPTANCE(){
 var r=[];function g(n,o,d){r.push({name:n,ok:!!o,detail:d||''});}
 var e=String(EligibilityBatchReadModel_get),l=String(PlanningWorkspaceConceptLifecycle_project);
 g('eligibilityTelemetryUsesReadPack',e.indexOf('readStrategy: readPack.readStrategy')>=0&&e.indexOf('windowFallback: readPack.windowFallback')>=0,'Eligibility hot-path telemetry uses actual bounded read pack.');
