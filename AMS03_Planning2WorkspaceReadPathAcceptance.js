...
function RUN_AMS03_PLANNING2_WORKSPACE_READ_PATH_ACCEPTANCE(){
 ...
 var f=r.filter(function(x){return!x.ok}),out={ok:!f.length,build:'2026-09-24_AMS03_PLANNING2_WORKSPACE_READ_PATH_R3',passed:r.length-f.length,total:r.length,results:r,meta:{priority:'P0_SPEED',runtimeMeasurementStillRequired:true}};Logger.log(JSON.stringify(out,null,2));return out;
}
