 ...
 * BUILD: 2026-09-14_CANONICAL_MODIFY_GRANDFATHER_TESTS_R1
 *
 * Non-destructive regression for the Modify-only planning-window exception.
 ***********************************************************************/
var PLANNING_CANONICAL_MODIFY_GRANDFATHER_TEST_BUILD='2026-09-14_CANONICAL_MODIFY_GRANDFATHER_TESTS_R1';
...
function RUN_PLANNING_CANONICAL_MODIFY_GRANDFATHER_REGRESSION(){
  ...
  t('moving_farther_outside_stays_blocked',function(){
    var x=PCMOD_grandfatherWindow_(PCMOD_TEST_gate_(false),PCMOD_TEST_rowInfo_(['2026-09-17','2026-09-18']),PCMOD_TEST_blocks_(['2026-09-24','2026-09-25']));
    return x.allowed===false&&x.reason==='RESCHEDULE_MOVES_FARTHER_OUTSIDE_WINDOW';
  });
  ...
  t('availability_hard_block_never_overridden',function(){
    var x=PCMOD_grandfatherWindow_(PCMOD_TEST_gate_(true),PCMOD_TEST_rowInfo_(['2026-09-17','2026-09-18']),PCMOD_TEST_blocks_(['2026-09-10','2026-09-11']));
  ...
  t('revision_conflict_never_overridden',function(){
    ...
    var x=PCMOD_grandfatherWindow_(g,PCMOD_TEST_rowInfo_(['2026-09-17','2026-09-18']),PCMOD_TEST_blocks_(['2026-09-10','2026-09-11']));
  ...
  var out={ok:failed===0,build:PLANNING_CANONICAL_MODIFY_GRANDFATHER_TEST_BUILD,total:results.length,passed:results.length-failed,failed:failed,results:results,meta:{nonDestructive:true,liveReadsPerformed:false,liveWritesPerformed:false,policy:'Modify-only; an already-outside planning may move inward or equally far outside, never farther. Other hard blocks and revision conflicts remain hard.'}};
