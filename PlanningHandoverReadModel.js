 ...
 ***********************************************************************/
var AMS03_HANDOVER_BUILD='2026-09-23_AMS03_PHASE9_HANDOVER_R1';
function PHR_s_(v){return String(v==null?'':v).trim();}
function getPlanningHandoverV5(payload){
 payload=payload||{};var t0=Date.now(),uid=PHR_s_(payload.companyUid),auditId=PHR_s_(payload.auditId),cp=getPlanningCompanyCommunicationV5({companyUids:uid?[uid]:[]}),company=(cp.companies||[])[0]||null,visit=null;
