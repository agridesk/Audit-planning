...
function PlanningProfilesService_get(input){
  ...
  var ss=SpreadsheetApp.getActive();PPS_mark_(perf,'resolveSpreadsheet',null);var includeCompanies=input.includeCompanies!==false,includeAuditors=input.includeAuditors!==false;
