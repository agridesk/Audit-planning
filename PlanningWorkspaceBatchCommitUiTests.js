 ...
 * BUILD: 2026-09-16_ROADMAP_2_4_WORKSPACE_BATCH_COMMIT_UI_TESTS_R4_CALLBACK_FLOW
 * Non-destructive source/wiring regression.
 ***********************************************************************/
var PLANNING_WORKSPACE_BATCH_COMMIT_UI_TEST_BUILD='2026-09-16_ROADMAP_2_4_WORKSPACE_BATCH_COMMIT_UI_TESTS_R4_CALLBACK_FLOW';
function RUN_PLANNING_WORKSPACE_BATCH_COMMIT_UI_REGRESSION(){
 ...
 var commitFn=js.indexOf('function commit()'),preflightCall=js.indexOf('PlanningWorkspaceRpc_batchPreflight',commitFn),doCommitCall=js.indexOf('doCommit(rows,b,wall)',commitFn),allReadyGuard=js.indexOf('if(d.allReady!==true)',commitFn),guardReturn=js.indexOf('return;',allReadyGuard),doCommitFn=js.indexOf('function doCommit('),batchCommitCall=js.indexOf('PlanningWorkspaceRpc_batchCommit',doCommitFn);
 ...
 t('allReadyRequired',allReadyGuard>commitFn);
 t('blockedReturnsBeforeDoCommit',guardReturn>allReadyGuard&&doCommitCall>guardReturn,'guard='+allReadyGuard+' return='+guardReturn+' doCommitCall='+doCommitCall);
 t('preflightSuccessCallsCommit',doCommitCall>allReadyGuard&&doCommitCall<preflightCall,'guard='+allReadyGuard+' doCommitCall='+doCommitCall+' preflightInvocation='+preflightCall);
 t('canonicalCommitIsSeparatedHelper',doCommitFn>=0&&batchCommitCall>doCommitFn);
