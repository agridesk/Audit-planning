 ...
 * BUILD: 2026-09-16_ROADMAP_2_4_WORKSPACE_BATCH_COMMIT_UI_TESTS_R2_PREFLIGHT_FIRST
 * Non-destructive source/wiring regression.
 ***********************************************************************/
var PLANNING_WORKSPACE_BATCH_COMMIT_UI_TEST_BUILD='2026-09-16_ROADMAP_2_4_WORKSPACE_BATCH_COMMIT_UI_TESTS_R2_PREFLIGHT_FIRST';
function RUN_PLANNING_WORKSPACE_BATCH_COMMIT_UI_REGRESSION(){
 ...
 t('preflightRpcUsed',js.indexOf('PlanningWorkspaceRpc_batchPreflight')>=0);
 t('batchRpcUsed',js.indexOf('PlanningWorkspaceRpc_batchCommit')>=0);
 t('preflightBeforeCommit',js.indexOf('PlanningWorkspaceRpc_batchPreflight')<js.indexOf('PlanningWorkspaceRpc_batchCommit'));
 t('allReadyRequired',js.indexOf('d.allReady!==true')>=0);
