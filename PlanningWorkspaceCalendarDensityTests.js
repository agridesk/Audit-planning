 ...
 * BUILD: 2026-09-10_PLANNING_WORKSPACE_CALENDAR_DENSITY_TEST_R1
 * Non-destructive contract regression. No business writes.
 ***********************************************************************/
var PLANNING_WORKSPACE_CALENDAR_DENSITY_TEST_BUILD='2026-09-10_PLANNING_WORKSPACE_CALENDAR_DENSITY_TEST_R1';
function RUN_PLANNING_WORKSPACE_CALENDAR_DENSITY_REGRESSION(){
  ...
  t('calendarBuildR4',cal.indexOf('CALENDAR_CLIENT_R4_DENSITY_METADATA')>=0);
