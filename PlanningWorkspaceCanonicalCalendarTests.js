 ...
 * BUILD: 2026-09-10_PLANNING_WORKSPACE_CANONICAL_CALENDAR_TEST_R4_ESCAPING_COMPAT
 * Read-only live + contract regression. No business writes.
 ***********************************************************************/
var PLANNING_WORKSPACE_CANONICAL_CALENDAR_TEST_BUILD='2026-09-10_PLANNING_WORKSPACE_CANONICAL_CALENDAR_TEST_R4_ESCAPING_COMPAT';
function RUN_PLANNING_WORKSPACE_CANONICAL_CALENDAR_REGRESSION(){
  ...
  t('readableCalendarItems',/CALENDAR_CLIENT_R(?:[5-9]|[1-9][0-9])_/.test(overlaySrc)&&overlaySrc.indexOf('readableItems:true')>=0);
  t('safeQuoteEscaping',overlaySrc.indexOf('&quot;')>=0&&overlaySrc.indexOf("'&quot'")<0);
