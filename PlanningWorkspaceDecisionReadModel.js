 ...
 * BUILD: 2026-09-23_AMS01_3_WORKSPACE_DECISION_READ_MODEL_R1
 *
 * Compact, read-only decision projection over existing canonical/read-model
 * owners. No new SSoT, cache or write path.
 ***********************************************************************/
var PLANNING_WORKSPACE_DECISION_READ_MODEL_BUILD='2026-09-23_AMS01_3_WORKSPACE_DECISION_READ_MODEL_R1';
...
function PlanningWorkspaceDecisionReadModel_get(input){
 ...
 var out={success:true,build:PLANNING_WORKSPACE_DECISION_READ_MODEL_BUILD,period:a.period,rows:rows,totals:a.totals||{},candidateAuditorEmails:emails,refreshPolicy:a.refreshPolicy||null,meta:{writes:false,newSsot:false,compactDecisionProjection:true,sourceOwner:'ConceptPlanningService_get',candidateAuditors:emails.length,sourceBuild:a.build||'',durationMs:Date.now()-t}};
 return out;
}
