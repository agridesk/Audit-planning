 ...
 * BUILD: 2026-09-10_PLANNING_WORKSPACE_DRAG_DROP_TEST_R3_INTERACTIVE_CALENDAR
 * Non-destructive contract regression. No business writes.
 ***********************************************************************/
var PLANNING_WORKSPACE_DRAG_DROP_TEST_BUILD='2026-09-10_PLANNING_WORKSPACE_DRAG_DROP_TEST_R3_INTERACTIVE_CALENDAR';
function RUN_PLANNING_WORKSPACE_DRAG_DROP_REGRESSION(){
  ...
  t('calendarBuildR2',cal.indexOf('PLANNING_WORKSPACE_CALENDAR_CLIENT_R2_CONCEPT_INTERACTION')>=0);
  ...
  t('existingClientsPreserved',shell.indexOf("PlanningWorkspaceClient.js")>=0&&shell.indexOf("PlanningWorkspaceEligibilityRecovery.js")>=0&&shell.indexOf("PlanningWorkspaceReAdjustClient.js")>=0&&shell.indexOf("PlanningWorkspaceWorkloadClient.js")>=0);
