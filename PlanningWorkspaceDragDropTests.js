...
function RUN_PLANNING_WORKSPACE_DRAG_DROP_REGRESSION(){
  ...
  t('calendarDensityMetadata',cal.indexOf('densityMetadata:true')>=0&&cal.indexOf('data-pw-cal-auditor')>=0&&cal.indexOf('data-pw-cal-hours')>=0);
  ...
  t('shellIncludesDensityClient',shell.indexOf("PlanningWorkspaceCalendarDensityClient.js")>=0);
