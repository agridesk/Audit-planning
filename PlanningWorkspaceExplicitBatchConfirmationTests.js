 ...
 * BUILD: 2026-09-18_WORKSPACE_EXPLICIT_BATCH_CONFIRM_R1
...
function RUN_WORKSPACE_EXPLICIT_BATCH_CONFIRM_REGRESSION(){
 ...
 t('configureNotHardDisabled',h.indexOf('id="configureNextSelected" class="btn primary" type="button" disabled')<0);
