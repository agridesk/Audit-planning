 ...
 * BUILD: 2026-09-19_WORKSPACE_EXPLICIT_PLANNING_PERIOD_R2
...
function RUN_WORKSPACE_EXPLICIT_PLANNING_PERIOD_REGRESSION(){
 ...
 t('initialPlanningPeriodDefaultsFromLoadedSearch',c.indexOf("if(pf&&!pf.value)pf.value=clean(loadedReq.from)")>=0&&c.indexOf("if(pt&&!pt.value)pt.value=clean(loadedReq.to)")>=0);
