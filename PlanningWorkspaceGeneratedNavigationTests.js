 ...
 * BUILD: 2026-09-19_WORKSPACE_GENERATED_NAVIGATION_R1
...
function RUN_WORKSPACE_GENERATED_NAVIGATION_REGRESSION(){
 ...
 t('generatedStateOwnedOutsideOverlay',c.indexOf('generatedConceptReservations:[]')>=0);
 t('generatedGetterUsesPersistentState',c.indexOf('function generatedConcepts(){return Array.isArray(state.generatedConceptReservations)')>=0);
 t('applyGeneratedWritesPersistentState',c.indexOf('state.generatedConceptReservations=Array.isArray(res&&res.conceptReservations)')>=0);
 ...
 t('generatedClearedOnExplicitReload',c.indexOf('state.generatedConceptReservations=[];state.batchGeneratedConcepts=[];state.decisionPerformance=null')>=0);
