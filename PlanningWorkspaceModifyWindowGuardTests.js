 ...
 * BUILD: 2026-09-14_WORKSPACE_MODIFY_WINDOW_GUARD_TESTS_R5_STRICT_HOURS
 ***********************************************************************/
var PLANNING_WORKSPACE_MODIFY_WINDOW_GUARD_TEST_BUILD='2026-09-14_WORKSPACE_MODIFY_WINDOW_GUARD_TESTS_R5_STRICT_HOURS';
function RUN_PLANNING_WORKSPACE_MODIFY_WINDOW_GUARD_REGRESSION(){
  ...
  t('guardShowsRequiredPlannedMissing',guard.indexOf("'Required: '")>=0&&guard.indexOf("' · Planned: '")>=0&&guard.indexOf("' · Missing: '")>=0);
  ...
  var out={ok:failed===0,build:PLANNING_WORKSPACE_MODIFY_WINDOW_GUARD_TEST_BUILD,total:r.length,passed:r.length-failed,failed:failed,results:r,meta:{nonDestructive:true,liveReadsPerformed:false,liveWritesPerformed:false,policy:'Modify obeys the strict canonical planning window, shows current audit dates distinctly, preserves base unavailability, and blocks Save with an explicit Required/Planned/Missing-hours message when planned hours are insufficient.'}};
