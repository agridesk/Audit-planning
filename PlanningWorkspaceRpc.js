 ...
 * BUILD: 2026-09-12_ROADMAP_2_4_WORKSPACE_RPC_R4_CONCEPT_DROP
 *
 * Browser-facing RPC boundary. Thin delegation only.
 * Stage timings are diagnostic only; they never own business truth.
 ***********************************************************************/
var PLANNING_WORKSPACE_RPC_BUILD='2026-09-12_ROADMAP_2_4_WORKSPACE_RPC_R4_CONCEPT_DROP';
...
function PlanningWorkspaceRpc_saveConcept(input){return PWR_envelope_('saveConcept',function(){return PlanningWorkspaceService_saveConcept(PWR_conceptInput_(input));});}
