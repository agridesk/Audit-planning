 ...
 ***********************************************************************/
var PLANNING_WORKSPACE_SERVER_HOTPATH_DIAGNOSTIC_BUILD='2026-09-23_WORKSPACE_SERVER_HOTPATH_DIAGNOSTIC_R4_SHARED_CONTEXT_ACCEPTANCE';
...
function RUN_PLANNING_WORKSPACE_BOOTSTRAP_FAST_PATH_ACCEPTANCE(){
  ...
  var a=snap(first),b=snap(second),checks={firstOk:a.ok,secondOk:b.ok,noCompanyProjection:a.companyProjectionUsed===false,noPreferredMonthsRead:a.preferredAuditMonthsRowsRead===0,noAvailabilityContextRead:a.availabilityContextBatchReads===0,noLifecycleRead:a.conceptLifecycleBatchReads===0,sharedContextFullySeeded:a.availabilityContextBatchReads===0&&a.availabilityContextMisses===0&&a.availabilityContextHits>0,warmUnderOneSecond:b.durationMs<1000};
