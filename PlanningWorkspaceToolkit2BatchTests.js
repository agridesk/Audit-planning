 ...
 * BUILD: 2026-09-10_PLANNING_WORKSPACE_TOOLKIT2_BATCH_TEST_R1
 * Combined non-destructive regression for the current visible Toolkit 2.0 batch.
 ***********************************************************************/
var PLANNING_WORKSPACE_TOOLKIT2_BATCH_TEST_BUILD='2026-09-10_PLANNING_WORKSPACE_TOOLKIT2_BATCH_TEST_R1';
function RUN_PLANNING_WORKSPACE_TOOLKIT2_BATCH_REGRESSION(){
  ...
  var failed=parts.filter(function(x){return!x.ok;}).length;
