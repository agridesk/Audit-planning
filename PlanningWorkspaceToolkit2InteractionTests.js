 ...
 * BUILD: 2026-09-10_PLANNING_WORKSPACE_TOOLKIT2_INTERACTION_TEST_R2_SOURCE_SCOPED
 * Non-destructive browser contract regression. No business writes.
 ***********************************************************************/
var PLANNING_WORKSPACE_TOOLKIT2_INTERACTION_TEST_BUILD='2026-09-10_PLANNING_WORKSPACE_TOOLKIT2_INTERACTION_TEST_R2_SOURCE_SCOPED';
function RUN_PLANNING_WORKSPACE_TOOLKIT2_INTERACTION_REGRESSION(){
  ...
  t('calendarR3',cal.indexOf('CALENDAR_CLIENT_R3_CANONICAL_AND_CONCEPT')>=0);
  ...
  var f=r.filter(function(x){return!x.ok;}).length,out={ok:f===0,build:PLANNING_WORKSPACE_TOOLKIT2_INTERACTION_TEST_BUILD,total:r.length,passed:r.length-f,failed:f,results:r,meta:{nonDestructive:true,liveReadsPerformed:false,liveWritesPerformed:false,existingFunctionalityRemoved:false,conceptCalendarInteraction:true,sourceScoped:true,availabilityWarnings:true,previewBeforePersist:true}};
