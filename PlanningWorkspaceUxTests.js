 ...
 * BUILD: 2026-09-10_PLANNING_WORKSPACE_UX_TEST_R2_COMPACT_OVERVIEW
 ***********************************************************************/
var PLANNING_WORKSPACE_UX_TEST_BUILD='2026-09-10_PLANNING_WORKSPACE_UX_TEST_R2_COMPACT_OVERVIEW';
function RUN_PLANNING_WORKSPACE_UX_REGRESSION(){
  ...
  t('buildMarker',src.indexOf('PLANNING_WORKSPACE_UX_CLIENT_R2_COMPACT_PLANNER_OVERVIEW')>=0);
  ...
  var out={ok:failed===0,build:PLANNING_WORKSPACE_UX_TEST_BUILD,total:r.length,passed:r.length-failed,failed:failed,results:r,meta:{readOnly:true,compactPlannerOverview:true,idleBatchPanelsHidden:true,newSsot:false,liveReadsPerformed:false,liveWritesPerformed:false}};
